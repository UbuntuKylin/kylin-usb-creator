...
void Page2::startMaking()
{
    playLoadingGif();
    lableNum->setText("0%");
    QDBusConnection::systemBus().connect(QString(),QString("/"),"com.usbbootdriver.interface","workingProgress",this,SLOT(dealWorkingProgress(int)));
    QDBusConnection::systemBus().connect(QString(),QString("/"),"com.usbbootdriver.interface","makeFinish",this,SLOT(dealMakeFinish(QString)));
}
